...
public class TranscriberDemo {       
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String wavFile = "src/main/resources/python_downloader/Abdurrahmaan_As-Sudais_64kbps/001/001.wav";
        ...
        configuration
                .setAcousticModelPath("src/main/resources/fatiha_model/fatiha.cd_cont_200");
        configuration
